...
# New fields to the blog and to the page
EXTRA_MODEL_FIELDS = (
  (
  ...
  (
    "mezzanine.blog.models.BlogPost.news",
    "django.db.models.BooleanField",
    ("News",),
    {"default": False},
  ),
  (
    "mezzanine.pages.models.Page.home",
    "django.db.models.BooleanField",
    ("Home",),
    {"default": False},
  ),
...
TEMPLATES = [
    {
        ...
        "DIRS": [
            ...
            os.path.join(BASE_DIR, 'quem_somos/templates/quem_somos'),
        ],
        "APP_DIRS": True,
        "OPTIONS": {
            'debug': DEBUG,
